  ...
  return (
    <div className="w-full bg-white min-h-screen font-['Inter',sans-serif] text-gray-900">
      <section className="relative max-w-6xl mx-auto px-6 lg:px-12 pt-20 pb-24">
        ...
        >
          {/* Email */}
          <motion.div variants={fadeUp} className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow text-center flex flex-col items-center">
            ...
            <a href="mailto:support@careercoach.ai" className="mt-6 text-[#6A0DAD] font-bold text-sm hover:underline">
          ...
          <motion.div variants={fadeUp} className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow text-center flex flex-col items-center">
            ...
            <p className="mt-6 text-black font-bold text-sm">
              Surat, Gujarat
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow text-center flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-black">Support Hours</h3>
            <p className="mt-3 text-gray-500 text-sm leading-relaxed font-medium">
        ...
        <motion.div 
          ...
          className="rounded-[2rem] bg-gray-50 border border-gray-200 shadow-sm p-10 md:p-14"
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm hover:border-[#6A0DAD]/30 transition-colors">
                <p className="text-black font-bold text-base flex items-start gap-3">
                  <span className="text-[#6A0DAD] mt-0.5"><span className="material-symbols-outlined text-[18px]">help</span></span>
                  {item.q}
                </p>
                <p className="mt-3 text-gray-600 text-sm leading-relaxed font-medium pl-8">
                  {item.a}
                </p>
              </div>
            ))}
